...
public class MLNodeTest
{
	...
	public void testNameAndID()
	{
		...
		assertNotEquals("Update the return value from getStudentID() in MLNode.java with your student id number",
				"1234567", n.getStudentID());
		assertNotEquals("Update the return value from getStudentName() in MLNode.java with your name",
				"MY NAME", n.getStudentName());
	}
	...
	public void testInitializeNode()
	{
		...
		assertNotEquals("1234567", n.getStudentID());
	}
